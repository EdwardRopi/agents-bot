...
const ORDER = ['interview', 'plan', 'smm', 'editor', 'reply', 'leads'];
  ...
  return [
    {
      ...
      body: 'Шесть агентов, каждый занят своим делом. За минуту покажу, кто чем — или пропустите, если хотите разобраться сами.',
    },
    {
