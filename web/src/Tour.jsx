...
const AGENT_TEXT = {
  manager:
    'Не знаете, к кому идти, — напишите ему своими словами. Он разберёт задачу, ' +
    'передаст тому, кто её сделает, и скажет прямо, если она не наша. ' +
    'Ответ приходит сюда же и отдельным уведомлением в Telegram.',
  interview:
 ...
 * Руководитель идёт первым: если человек бросит тур на втором шаге,
 * он всё равно унесёт главное — есть тот, кому можно написать не разбираясь.
 */
